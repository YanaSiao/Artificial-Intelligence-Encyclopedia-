...
## The Failure of Local Representations
...
| **[[Discrete and Continuous Bag of Words\|Bag-of-Words]] (BoW):** Document as a word set. | **Latent Dirichlet Allocation (LDA):** Topic-based. |
| **1-of-N (One-Hot):** Discrete atomic symbols.                                            | **Distributed Representations:** Dense vectors.     |

## The Benefits of Distributed Representations
